...
class Lista {
    ...
    public void ordenarResp(int tam, int tamArq) {
    ...
    public void criarHeap(int n, int i) {
        int largest = i;
        int l = 2 * i + 1;
        int r = 2 * i + 2;
        if (l < n && array[l].getReleaseDate().after(array[largest].getReleaseDate())) {
            largest = l;
        }
        if (r < n && array[r].getReleaseDate().after(array[largest].getReleaseDate())) {
            largest = r;
        }
        if (largest != i) {
            tempG = array[i];
...
class questao5 {
    ...
    public static void main(String[] args) {
        ...
        if (pcOuVerde == 1) {
            Arq.openWrite("tmp/matricula_heapsort.txt", "UTF-8");
            Arq.print("762723\t");
            Arq.print("n(n-1)/2\t");
            Arq.print("n\t");
